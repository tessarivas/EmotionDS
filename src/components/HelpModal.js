          ...
          <div className="p-6 space-y-6">
            <div>
              ...
              <p className="text-gray-600 text-xl">
                Nuestro sistema de inteligencia artificial puede identificar
                emociones básicas en personas con Síndrome de Down mediante el
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-lg">
                      Arrastra una foto o haz clic en "Subir imagen". Asegúrate
                      de que el rostro sea visible.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-lg">
                      Nuestro sistema procesará la imagen y detectará las
                      emociones presentes.
                    </p>
                  </div>
                </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600 text-lg">
                ...
                <li className="flex items-center space-x-2">
                  <span className="w-2 h-2 bg-cyan-500 rounded-full"></span>
                  <span>
                    Asegúrate de que el rostro esté claramente visible
                  </span>
                </li>
                <li className="flex items-center space-x-2">
                  <span className="w-2 h-2 bg-cyan-500 rounded-full"></span>
