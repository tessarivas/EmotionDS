    ...
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-40 p-4 font-nats">
        <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full transform transition-all duration-300 scale-100">
          {/* Header del modal */}
          <div
            className={`${config.lightBg} p-6 rounded-t-2xl border-b border-gray-200`}
          >
          ...
          <div className="p-8 text-center space-y-6">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <p className="text-md text-gray-500">
                ...
                Los resultados pueden no ser completamente precisos. Este
                proyecto está diseñado para asistir en el reconocimiento de
                emociones básicas.
              </p>
            </div>
          </div>
